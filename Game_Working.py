...
def remove_punct(text):
    ...
    marks from ha string. Spaces do not count as punctuation and should
...
def print_menu(exits):
        ...
        for direction, room in exits.items():
                print("Go " + direction.upper() + " to " + room + ".")
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        normalisation = normalise_input(user_input)
        #print(str(normalisation.split(" ")))
        # Check if the input makes sense (is valid exit)
        direction = normalisation.split(" ")[0]
